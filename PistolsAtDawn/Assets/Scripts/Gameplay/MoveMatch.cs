...
{    
	...
	{
		if (other.gameObject.name == "StrikeRegion") 
		{
			// Hit edge, move back to start
			this.transform.position = startPos;
			resetLine();
			isMousePressed = false;
		}
		else if (other.gameObject.name == "WinningRegion") 
		{
			// Got to the goal region without touching the edges!
			this.transform.position = startPos;
			resetLine();
			isMousePressed = false;
